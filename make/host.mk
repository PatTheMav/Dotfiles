...
install-packages : | $(PKG_CMD) $(PKG_PREREQS)
	@$(OUTPUT) "\033[34m==> \033[39;1mInstalling apt packages...\033[0m"
	@$(PWD)/local/bin/aptfile

## Run apt cleanup
clean-packages : | $(PKG_CMD) $(PKG_PREREQS)
	@$(OUTPUT) "\033[32m==> \033[39;1mCleaning up $(PKG_NAME) environment...\033[0m"
	@sudo $(PKG_CMD) autoclean && sudo $(PKG_CMD) autoremove || true

## Install specific apt package
$(BIN_DIR)/% :
	@$(OUTPUT) "\033[34m==> \033[39;1mInstalling $(notdir $@) via apt...\033[0m"
...
update-packages : | $(PKG_CMD) $(PKG_PREREQS)
	@$(OUTPUT) "\033[32m==> \033[39;1mUpdating $(PKG_NAME) packages...\033[0m"
...
install-packages : | $(PKG_CMD) $(PKG_PREREQS)
	@$(OUTPUT) "\033[34m==> \033[39;1mInstalling Homebrew packages...\033[0m"
	@$(PKG_CMD) bundle
...
$(BREW_ROOT)/Cellar/% : | $(PKG_CMD)
	@$(OUTPUT) "\033[34m==> \033[39;1mInstalling $(notdir $@) from Homebrew...\033[0m"
...
base16-% : | $(PWD)/local/config/base16-shell/base16-%.sh
	@$(OUTPUT) "\033[32m==> \033[39;1mEnabling base16 shell theme $@...\033[0m"
