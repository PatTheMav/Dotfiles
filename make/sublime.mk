...
$(ST_PATH)/User : | $(ST_PATH)
	@test -d '$@' && mv '$@' '$@.old' || true
	@$(OUTPUT) "\033[32m==> \033[37;1mLinking Sublime Text configuration directory...\033[0m"
...
$(ST_PATH)/User/Preferences.sublime-settings : | $(ST_PATH)/User
	@$(OUTPUT) "\033[32m==> \033[37;1mLinking Sublime Text $(OS) configuration...\033[0m"
...
%.sublime-settings : %.sublime-settings.enc
	@$(OUTPUT) "\033[32m==> \033[37;1mDecrypting $(notdir $@) settings for Sublime Text...\033[0m"
...
$(SM_PATH)/User : | $(SM_PATH)
	@test -d '$@' && mv '$@' '$@.old' || true
	@$(OUTPUT) "\033[32m==> \033[37;1mLinking Sublime Merge configuration...\033[0m"
